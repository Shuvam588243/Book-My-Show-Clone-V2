...
const OnlineStreamingEventsCard = (props) => {
  return (
    <>
...
const OnlineStreamingEventsCardSlider = () => {
  const OnlineStreamingEventsImage = [
  ...
  return (
    <>
      <Slider {...settings}>
        {OnlineStreamingEventsImage.map((image) => (
          <OnlineStreamingEventsCard src={image} />
        ))}
      </Slider>
    </>
  );
...
export default OnlineStreamingEventsCardSlider;
